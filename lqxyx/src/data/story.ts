...
export const firstActCheckpoints: StoryCheckpoint[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      { type: "switchCharacter", characterId: "yangYunRed", visibleName: "杨云", control: "player" },
      { type: "task", text: "去办公室" },
      { type: "interaction", input: "F", target: "办公室门口两门任一", result: "进入办公室过渡", physicalTarget: { floorId: "4F", roomId: null, points: [{ x: 912, y: 868, radiusPx: 48 }, { x: 912, y: 1028, radiusPx: 48 }] } },
  ...
  },
  {
    ...
    commands: [
      ...
      { type: "fade", direction: "out", durationMs: 500 },
      { type: "switchView", characterId: "yangYunRed", location: "办公室门口，人物朝向向左", locationState: { floorId: "4F", roomId: null }, position: { x: 876, y: 868 }, facing: "left" },
      { type: "switchCharacter", characterId: "yangYunRed", visibleName: "杨云", control: "player" },
      { type: "fade", direction: "in", durationMs: 500 },
  ...
  },
  {
    ...
    commands: [
      ...
      { type: "setFlag", id: "yangYunReplayRestoresHeads", value: true },
...
export const firstActBranches: StoryBranch[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      { type: "interaction", input: "F", target: "五楼校长办公室门口", result: "不进入，黑屏对白", physicalTarget: { floorId: "5F", roomId: null, points: [{ x: 368, y: 2012, radiusPx: 48 }] } },
      { type: "task", text: "无" },
      { type: "fade", direction: "out", durationMs: 500 },
  ...
  },
  {
    ...
    commands: [
      ...
      { type: "setFlag", id: "yangYunReplayRestoresHeads", value: true },
      { type: "setFlag", id: "yangYunReplayDanHeadPickedUp", value: false },
