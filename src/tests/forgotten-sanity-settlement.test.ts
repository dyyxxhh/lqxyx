...
import { SettlementScreen, SETTLEMENT_DEPTH } from '../forgottenSanity/ui/SettlementScreen';
import {
...
import type { Inventory, InventoryEntry } from '../forgottenSanity/loot/Inventory';
