...
#[test]
fn game_remove_with_yes_removes_record_and_leaves_disk() {
    let home = TestHome::new();
    home.write_config(GAME_DEV_TOML);
    home.cmd()
        ...
        .success()
        .stdout(
            predicate::str::contains("removed game record: dev")
                .and(predicate::str::contains("root_dir (left on disk)")),
        );
...
// ---------------------------------------------------------------------------
// game install remains stubbed
// ---------------------------------------------------------------------------

#[test]
fn game_install_valid_target_reaches_stub() {
    let home = TestHome::new();
    home.cmd()
        ...
        .stderr(predicate::str::contains(
            "game install is not implemented yet",
        ));
}
