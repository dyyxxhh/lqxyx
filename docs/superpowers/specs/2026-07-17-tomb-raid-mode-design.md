...
#### §5.11.2 感知二通道
- **视野锥**：120° 圆锥，朝向 = 怪物当前移动方向（静止时保持上次朝向），半径随怪种（见 §5.11.6）
...
#### §5.11.6 怪种参数表
| 怪种 | 视野R(px) | 噪声敏感度 | 警觉→追击 | 追击→搜索 | 搜索→警觉 | 警觉→待机 | 巡逻类型 | 设计理由 |
|------|----------|-----------|-----------|-----------|-----------|-----------|----------|----------|
| ① 但宇轩头颅 | 350 | 1.0× | 即转 | 3s | 3s | 5s | 游走 | 远程射手，标准感知 |
| ② 秦浩睿头颅 | 320 | 1.0× | 即转 | 3s | 3s | 5s | 游走 | 尖叫型，标准 |
| ③ 桌椅 | 180 | 0.7× | 2s | 4s | 4s | 6s | 静物 | 听觉迟钝，近战 |
| ④ 电话 | 280 | 1.3× | 2s | 2s | 2s | 4s | 静物 | 电话=听觉锐，反应快 |
| ⑤ 血手 | 150 | 1.0× | 1s | 4s | 4s | 6s | 静物 | 伏击型，近身瞬转 |
| ⑥ 漂浮眼球 | 400 | 0.8× | 即转 | 3s | 3s | 5s | 游走 | 视觉主导，远视但听觉差 |
| ⑦ 粉笔尘云 | 250 | 1.0× | 即转 | 5s | 5s | 7s | 静物 | 移动慢，搜索久 |
| ⑧ 血瞳头颅 | 380 | 1.2× | 即转 | 2s | 2s | 4s | 游走 | 强化版头颅，反应快 |
